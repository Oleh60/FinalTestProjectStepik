...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        self.login_page = LoginPage(browser, url="http://selenium1py.pythonanywhere.com/uk/")
        self.login_page.open()
        self.login_page.register_new_user(email=str(time.time()) + "@fakemail.com",password=str(4 * 4) + "FaKePassWord")
